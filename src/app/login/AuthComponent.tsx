...
export default function AuthComponent() {
  ...
  const onLoginSubmit: SubmitHandler<LoginFormInputs> = async (data) => {
    ...
    if (result?.ok) {
      router.replace("/dashboard/pipeline"); // replace recomendado
      router.refresh();
    } else {
            ...
            <TabsContent value="login" className="mt-4">
              ...
              >
                <div className="grid gap-2 relative">
                  ...
                  <Mail className="absolute left-3 top-8 h-4 w-4 text-muted-foreground" />
                  <Input
                    id="email-login"
                    type="email"
                ...
                <div className="grid gap-2 relative">
                  ...
                  <Lock className="absolute left-3 top-8 h-4 w-4 text-muted-foreground" />
                  <Input
                    id="password-login"
                    type="password"
                    required
            ...
            <TabsContent value="register" className="mt-4">
              ...
              >
                <div className="grid gap-2 relative">
                  ...
                  <User className="absolute left-3 top-8 h-4 w-4 text-muted-foreground" />
                  <Input
                    id="name-reg"
      ...
      <div className="hidden bg-gray-900 lg:flex relative flex-col justify-end p-10">
        ...
        <div className="relative z-10 text-white">
          <h2 className="text-4xl font-bold">
            La gestión de tus clientes, simplificada.
          </h2>
          <p className="mt-4 text-lg">
            Nuestro CRM te da las herramientas para nunca perder una oportunidad
            de venta.
          </p>
        </div>
      </div>
