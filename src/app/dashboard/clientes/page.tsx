...
const orderedColumns = Object.keys(
  DEFAULT_VISIBILITY
...
export default function ClientesPage() {
  ...
  // Normaliza y deduplica prioridades para evitar "alta" vs "Alta" en el select
  ...
  if (isError)
    return (
      <div className="p-10 text-center text-red-600">Error al cargar los clientes.</div>
    );
  ...
  return (
    <div className="mx-auto py-4 px-4 md:px-4">
      <div className="flex flex-col md:flex-row justify-between md:items-start gap-4 border-b mb-4">
        ...
        {/* Mobile actions (solo Nuevo Cliente) */}
              ...
              <TableRow key={cliente._id}>
                {columnVisibility["Nombre Completo"] && (
                  <TableCell className="font-medium text-left">
                    <Link
                      href={`/dashboard/clientes/${cliente._id}`}
                ...
                {columnVisibility["Último Contacto"] && (
                  <TableCell className="text-center">
                    {cliente.ultimoContacto
                      ? format(new Date(cliente.ultimoContacto), "dd MMM yyyy", {
                          locale: es,
                        })
                      : "Sin Contactar"}
                  </TableCell>
